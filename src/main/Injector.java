...
public class Injector
{
	...
	public void inject (boolean bNew) throws IOException, InterruptedException, URISyntaxException
	{
		...
		//first, copy hs.app from files9 folder to input folder of inject generator
		...
		copyFile("./temp/Universal-Inject-Generator-master/"+folder+"/fbi.cia", "./temp/Universal-Inject-Generator-master/input/fbi.cia");

		//third, run go.bat
		Runtime.getRuntime().exec(new String[]{"cmd", "/c", "start", "go.bat"}, null, new File("./temp/Universal-Inject-Generator-master/"));
		...
		//give it a chance to clos
		TimeUnit.SECONDS.sleep(1);

		//fourth, copy the new fbi app to files9 folder
		copyFile("./temp/Universal-Inject-Generator-master/fbi_inject_with_banner.app", "./files9/fbi_inject_with_banner.app");
